...
public class ConnectionManagerChats {
        public Context mContext ;
        public static SharedPrefData sharedPrefData ;

    public ConnectionManagerChats(Context mContext) {
    ...
    public static void addConnectionManagementHandler(String handlerId, final ConnectionManagementHandler handler) {
        ...
        if (SendBird.getConnectionState() == SendBird.ConnectionState.OPEN) {
            ...
            String userId = sharedPrefData.getElementValue(DataConstant.promoterDataNameSpFile,DataConstant.agencyIDJsonKeyUpcase);
            SendBird.connect(userId, new SendBird.ConnectHandler() {
                @Override
                public void onConnected(User user, SendBirdException e) {
                    if (e != null) {
