...
public class ProductsAdapter extends RecyclerView.Adapter<ProductsAdapter.myViewHolder> {
    ...
    int setPriceVisable,setCountVisable;
    SharedPrefData sharedPrefData ;


    public ProductsAdapter(Context mContext ,List<itemCardReport> mData) {
    ...
    public ProductsAdapter.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        ProductsAdapter.myViewHolder vHolder = new ProductsAdapter.myViewHolder(viewIt);
        return vHolder;
    }
    ...
    public void onBindViewHolder(@NonNull ProductsAdapter.myViewHolder holder, int position) {
        ...
        holder.tv_countPtt.setText(mData.get(position).getItemCount());
         ...
         boolean isPriceHdn = sharedPrefData.getElementBooleanValue(DataConstant.promoterDataNameSpFile,DataConstant.priceProdtHdn);
          boolean isCountHdn = sharedPrefData.getElementBooleanValue(DataConstant.promoterDataNameSpFile,DataConstant.countProdtHdn);
