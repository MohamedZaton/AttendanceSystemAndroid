...
import com.pclink.attendance.system.Chat.utils.FileUtils;
import com.pclink.attendance.system.Chat.utils.MediaPlayerActivity;
import com.pclink.attendance.system.Chat.utils.PhotoViewerActivity;
import com.pclink.attendance.system.Chat.utils.TextUtils;
import com.pclink.attendance.system.Chat.utils.UrlPreviewInfo;
import com.pclink.attendance.system.Chat.utils.WebUtils;
...
import com.pclink.attendance.system.Notification.OneSignalHelper;
...
public class GroupChatFragment extends Fragment {
        public ConnectionManagerChats  connectionManagerChats ;
    ...
    public static GroupChatFragment newInstance(@NonNull String channelUrl) {
        ...
        args.putString(MessageListActivity.EXTRA_GROUP_CHANNEL_URL, channelUrl);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            mChannelUrl = getArguments().getString(MessageListActivity.EXTRA_GROUP_CHANNEL_URL);
        }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        connectionManagerChats = new ConnectionManagerChats(getContext());
        ...
        sharedPrefData = new SharedPrefData(getContext());
        supervisorId =  sharedPrefData.getElementValue(DataConstant.promoterDataNameSpFile,DataConstant.supervisorID );
        ...
        mMessageSendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mCurrentState == STATE_EDIT) {
                    ...
                    if (userInput.length() > 0) {
                        int fromID = Integer.parseInt(sharedPrefData.getElementValue(DataConstant.promoterDataNameSpFile,DataConstant.agencyIDJsonKeyUpcase));
                        int  toID = Integer.parseInt(supervisorId);
                        notificationHelper.sendMessageNotification(fromID,toID,mMessageEditText.getText().toString());
    ...
    public void onResume() {
        ...
        connectionManagerChats.addConnectionManagementHandler(CONNECTION_HANDLER_ID, new ConnectionManagerChats.ConnectionManagementHandler() {
            @Override
    ...
    public void onPause() {
        ...
        connectionManagerChats.removeConnectionManagementHandler(CONNECTION_HANDLER_ID);
    ...
    public void onAttach(Context context) {
        ...
        ((MessageListActivity)context).setOnBackPressedListener(new MessageListActivity.onBackPressedListener() {
            @Override
    ...
    private void updateActionBarTitle() {
        ...
        if (getActivity() != null) {
            ((MessageListActivity) getActivity()).setActionBarTitle(title);
        }
    }
